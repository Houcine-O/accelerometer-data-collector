  ...
  protected SupportSQLiteOpenHelper createOpenHelper(DatabaseConfiguration configuration) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(3) {
      ...
      public void createAllTables(SupportSQLiteDatabase _db) {
        _db.execSQL("CREATE TABLE IF NOT EXISTS `recolts` (`a` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `laltitude` REAL NOT NULL, `longitude` REAL NOT NULL, `speed` REAL NOT NULL, `direction` REAL NOT NULL, `x` REAL NOT NULL, `y` REAL NOT NULL, `z` REAL NOT NULL)");
        _db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        _db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, \"b5c1ce202b6f96132681ab251dc523b6\")");
      }
      ...
      protected void validateMigration(SupportSQLiteDatabase _db) {
        final HashMap<String, TableInfo.Column> _columnsRecolts = new HashMap<String, TableInfo.Column>(8);
    ...
    }, "b5c1ce202b6f96132681ab251dc523b6", "b7ea1f04eb6efcbd57fb16a5a4de1a49");
